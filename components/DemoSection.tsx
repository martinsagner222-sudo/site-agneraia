    ...
    <section className="py-20 md:py-32 px-6 bg-[#111111] overflow-hidden">
      <div className="container mx-auto text-center">
        ...
        <div className="mt-16 relative aspect-video max-w-5xl mx-auto rounded-2xl glow-border bg-black p-2">
           <img
            src="https://picsum.photos/seed/holographicdata/1200/675"
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-gray-900/50 p-6 rounded-xl border border-gray-800 text-left glow-border">
                ...
                <img src="https://picsum.photos/seed/socialcrm/400/250" alt="IA classificando leads de redes sociais" className="mt-4 rounded-md object-cover"/>
            </div>
            <div className="bg-gray-900/50 p-6 rounded-xl border border-gray-800 text-left glow-border">
                ...
                <p className="text-gray-400 mt-2 text-sm">A IA negocia horários com o cliente via WhatsApp e preenche a agenda do consultor sem intervenção.</p>
                 <img src="https://picsum.photos/seed/scheduleui/400/250" alt="Agenda digital sendo preenchida automaticamente" className="mt-4 rounded-md object-cover"/>
            </div>
            <div className="bg-gray-900/50 p-6 rounded-xl border border-gray-800 text-left glow-border">
                ...
                <p className="text-gray-400 mt-2 text-sm">Novos contatos e o histórico de conversas são enviados instantaneamente para o CRM da empresa.</p>
                 <img src="https://picsum.photos/seed/dashboardcrm/400/250" alt="Painel de CRM com novos contatos" className="mt-4 rounded-md object-cover"/>
            </div>
        </div>
      </div>
    </section>
